if ($('#chart_ptkt_ct_1').length > 0) {
    am5.ready(function() {
        ...
        yesDataItem1.get("label").setAll({ text: "SELL", forceHidden: false, fontSize: "0.9em", fontWeight: "600" });
        ...
        yesDataItem2.get("label").setAll({ text: "NEUTRAL", forceHidden: false, fontSize: "0.9em", fontWeight: "600" });
        ...
        yesDataItem3.get("label").setAll({ text: "BUY", forceHidden: false, fontSize: "0.9em", fontWeight: "600", });
        ...
        yesDataItem4.get("label").setAll({ text: "STRONG\nBUY", forceHidden: false, fontSize: "0.9em", fontWeight: "600", lineHeight: 1.5 });
...
if ($('#chart_ptkt_ct_2').length > 0) {
    am5.ready(function() {
        ...
        yesDataItem1.set("endValue", 4);
        xAxis.createAxisRange(yesDataItem1);
        yesDataItem1.get("label").setAll({ text: "SELL", forceHidden: false, fontSize: "0.6em", fontWeight: "600" });
        yesDataItem1.get("axisFill").setAll({
            visible: true,
            fillOpacity: 1,
            fill: "#f4959d",
        ...
        yesDataItem2.set("endValue", 6);
        xAxis.createAxisRange(yesDataItem2);
        yesDataItem2.get("label").setAll({ text: "NEUTRAL", forceHidden: false, fontSize: "0.6em", fontWeight: "600" });
        yesDataItem2.get("axisFill").setAll({
            visible: true,
            fillOpacity: 1,
            fill: "#d3d6db",
        ...
        yesDataItem3.set("endValue", 8);
        xAxis.createAxisRange(yesDataItem3);
        yesDataItem3.get("label").setAll({ text: "BUY", forceHidden: false, fontSize: "0.6em", fontWeight: "600", });
        yesDataItem3.get("axisFill").setAll({
            visible: true,
            fillOpacity: 1,
            fill: "#569ac7",
        ...
        yesDataItem4.set("endValue", 10);
        xAxis.createAxisRange(yesDataItem4);
        yesDataItem4.get("label").setAll({ text: "STRONG\nBUY", forceHidden: false, fontSize: "0.6em", fontWeight: "600", lineHeight: 1.5 });
        yesDataItem4.get("axisFill").setAll({
            visible: true,
            fillOpacity: 1,
            // fill:root.interfaceColors.get("positive"),
